...
INSERT INTO products (name, price, image_path, is_makeup, age, brand_id, skintype_id, type_id, ingredients, description,
                      how_to_use)
VALUES ('Salicylic Acid 2% Solution', 41.00, 'src/img/product1.webp', 0, 0, 1, 5, 6,
       ...
       ('Moisturizers loțiune hidratantă pentru corp și față pentru pielea uscata sau foarte uscata', 110.00,
       ...
       ('Skin Naturals Vitamin C crema de ochi iluminatoare cu vitamina C', 47.00, 'src/img/product14.webp', 0, 0, 7, 5,
        9,
       ...
       ('Bio Graceful Lavandin crema anti-imbatranire pentru ochi si buze', 37.00, 'src/img/product23.webp', 0, 35, 7,
        5, 10,
       ...
       ('Dior Addict Lip Maximizer luciu de buze pentru un volum suplimentar', 187.00, 'src/img/product28.webp', 1, 0,
        12, 5, 24,
       ...
       ('Color Riche Intense Volume Matte Colors of Worth ruj buze mat hidratant editie limitata', 55.00,
       ...
       ('False Lash Bambi Oversized Eye mascara pentru volum, alungire si separarea genelor', 65.00,
       ...
       ('Calligraph Pro Precise 24h Matt dermatograf rezistent la apă', 20.00, 'src/img/product38.webp', 1, 0, 13, 5,
        21,
       ...
       ('Cant Stop Wont Stop Full Coverage Foundation fond de ten cu acoperire ridicată', 85.00,
